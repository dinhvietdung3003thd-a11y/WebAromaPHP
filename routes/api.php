...
Route::prefix('Auth')->group(function () {
    ...
    Route::middleware(['custom.jwt', 'jwt.token_version'])->group(function () {
...
Route::middleware(['custom.jwt', 'jwt.token_version', 'role:Admin,Staff'])->group(function () {
...
Route::middleware(['custom.jwt', 'jwt.token_version', 'role:Customer'])->prefix('client')->group(function () {
